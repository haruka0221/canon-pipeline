...
target = v10[
    v10["goodreads_resolution_status"].eq("NO_AUTHOR_SUPPORT")
    & v10["goodreads_candidate_count"].eq("1")
].copy()
...
assert len(x) == 922
assert (x["source_batch"] == "old_1122").sum() == 906
