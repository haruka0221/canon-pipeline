...
target = v7[
    v7["goodreads_resolution_status"].eq("NO_AUTHOR_SUPPORT")
    & v7["goodreads_candidate_count"].eq("1")
].copy()
...
assert len(x) == 933
assert (x["source_batch"] == "old_1122").sum() == 917
