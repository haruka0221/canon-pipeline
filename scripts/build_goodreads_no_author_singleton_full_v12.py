...
V11 = ROOT / "derived/goodreads_resolution_status_v12.tsv"
OLD = ROOT / "derived/goodreads_llm_review_batch1_v3.tsv"
OUTLANG = ROOT / "derived/goodreads_outlang_singleton_full28_v1.tsv"

OUT = ROOT / "derived/goodreads_no_author_singleton_full_v12.tsv"
OUT_TRIAGE = (
    ROOT
    / "derived/goodreads_no_author_singleton_full_v12_temporal_triage.tsv"
)
...
assert len(x) == 913
assert (x["source_batch"] == "old_1122").sum() == 897
