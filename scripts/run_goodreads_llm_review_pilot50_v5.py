...
INPUT = ROOT / "derived/goodreads_llm_review_pilot50_v5.tsv"
PROMPT_FILE = ROOT / "prompts/goodreads_identity_review_v5.txt"
OUTPUT = ROOT / "derived/goodreads_llm_review_pilot50_v5_results.tsv"
    ...
    case = {
        ...
        "goodreads": {
            ...
            "primary_contributors":
                row["gr_primary_contributors"],
            "pseudonym_contributors":
                row["gr_pseudonym_contributors"],
            "editors":
                row["gr_editors"],
            "translators":
                row["gr_translators"],
            "adapters_retellers":
                row["gr_adapters_retellers"],
            "other_contributors":
                row["gr_other_contributors"],
        },
    }
